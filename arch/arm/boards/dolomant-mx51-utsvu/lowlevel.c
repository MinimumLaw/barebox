...
extern char __dtb_imx51_utsvu_start[];

ENTRY_FUNCTION(start_imx51_utsvu, r0, r1, r2)
{
	void *fdt;
	...
	fdt = __dtb_imx51_utsvu_start - get_runtime_offset();

	imx51_barebox_entry(fdt);
}

static noinline void utsvu_entry(void)
{
...
ENTRY_FUNCTION(start_imx51_utsvu_xload, r0, r1, r2)
{
	imx5_cpu_lowlevel_init();
